...
<head>
    ...
    <meta property="og:image" content="http://adventurepod.co/wp-content/uploads/2018/06/free-printable-certificate-of-completion-online-templates.jpg"/>
...
<script>
    ...
    jQuery(document).ready(function ($) {
        $(document).on('click',function(){
            console.time('a')
                html2canvas($('.single-certificate-content')[0], {
